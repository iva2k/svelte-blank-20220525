...
Fix: add the following to package.json (note that "." item in "exports" refers to the path relative to the output generated by `svelte-kit package` in "package" directory):
